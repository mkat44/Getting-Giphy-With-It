$(document).ready(function() {
    ...
    // global variables
    topics = ["The Little Mermaid", "The Lion King", "Aladdin", "Brave", "Up", "Tangled", "Frozen", "Moana", "Coco", "Wall-E", "Inside Out", "The Good Dinosaur", "Toy Story",
              "Finding Nemo", "Lilo & Stitch", "Cinderella", "Sleeping Beauty", "Beauty and the Beast", "Mulan", "Zootopia", "Spirited Away", "Totoro", "Ponyo", "Princess Mononoke",
              "Howl's Moving Castle", "Nausicaa", "Star Wars", "Avengers", "Thor", "Captain America", "Iron Man", "Spider-Man", "Black Panther", "Doctor Strange"];
    limit = 10;
    var searchTerm = "";
