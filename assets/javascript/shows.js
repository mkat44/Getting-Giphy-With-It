$(document).ready(function() {
    ...
    // global variables
    topics = ["Legion", "Mr. Robot", "Orphan Black", "Star Trek", "Jessica Jones", "Iron Fist", "Daredevil", "Punisher", "Luke Cage", "sense8", "The OA", "Battlebots", "Steven Universe",
              "Once Upon a Time", "Dark", "Handmaid's Tale", "Runaways", "The 100", "The Walking Dead", "Stranger Things", "Altered Carbon", "Unbreakable Kimmy", "GLOW"];
    limit = 10;
    var searchTerm = "";
