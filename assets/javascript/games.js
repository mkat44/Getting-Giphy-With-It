$(document).ready(function() {
    ...
    // global variables
    topics = ["Super Mario", "Smash Bros", "Kirby", "Legend of Zelda", "Persona", "Fire Emblem", "Final Fantasy", "Tales of Symphonia", "Tales of the Abyss", "Assassin's Creed", 
              "Mario Kart", "Katamari", "Pokemon", "Mega Man", "Sonic", "Metroid", "Metal Gear Solid", "Splatoon", "Pikmin", "Paper Mario", "Tetris", "Devil May Cry"];
    limit = 10;
    var searchTerm = "";
